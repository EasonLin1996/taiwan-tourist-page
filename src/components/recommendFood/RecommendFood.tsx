...
const recommendFoodList = [
  {
    ...
    imgUrl: imgFood02,
    link: "/searchPage/detailPage?cate=Restaurant&id=C3_376500000A_000791",
  }, {
    title: "鄭記香腸",
    descrip: "位於小琉球的老街上，最古早的鄭記琉球香腸老店創立於民國43年，已成為小琉球當地的名產之一。",
    imgUrl: imgFood01,
    link: "/searchPage/detailPage?cate=Restaurant&id=C3_376530000A_000049",
  }, {
    title: "石碇一粒粽",
    descrip: "粽子主打不油膩、吃了不脹氣，且選用最優質的材料，其中又以桂花粽最為特別，將整朵桂花加入粽子做調味，品嘗粽子的同時也能嚐到桂花香。",
    imgUrl: imgFood03,
    link: "/searchPage/detailPage?cate=Restaurant&id=C3_382000000A_207455",
  }, {
    title: "兩支北方麵食館",
    descrip: "專營北方麵食點心，從各式蒸餃、牛肉麵、酸辣麵等風味佳餚，堅持道地美味的執著，從醒麵、桿皮、包餡到成品，每一個環節都是對客戶的尊重與責任。",
    imgUrl: imgFood04,
    link: "/searchPage/detailPage?cate=Restaurant&id=C3_382000000A_209035",
  }, {
    title: "阿妃健康廚房",
    descrip: "每顆水餃從肉餡、使用豐富的蔬菜、調味料的比例、水餃皮的手感與功夫，層層步驟讓水餃能兼具口感與高纖維，也讓營養價值更高。",
    imgUrl: imgFood05,
    link: "/searchPage/detailPage?cate=Restaurant&id=C3_382000000A_206134",
  }, {
    title: "鶴岡紅茶舖",
    descrip: "店內販售花蓮瑞穗有機生態農場所種植的有機茶，坐下品嚐一杯香甜回甘的好茶，可以讓人暫時放掉煩惱，享受純淨的片刻。",
    imgUrl: imgFood06,
    link: "/searchPage/detailPage?cate=Restaurant&id=C3_376550000A_000202",
  }, {
    title: "三家村陽春麵",
    descrip: "餐點上桌前，將佐料瑤舀進碗內，再加入一大早熬製的大骨高湯，最後放進麵條，保持麵體彈性口感不軟爛。",
    imgUrl: imgFood07,
    link: "/searchPage/detailPage?cate=Restaurant&id=C3_315081600H_000338",
  },
]
      ...
      <div className="container">
        <Row className={styles['txt-box']}>
          ...
          <Col span={12} className={styles['desc-box']}>
            ...
            <a href="/searchpage?category=Restaurant" className="homepage-link">
              享用更多美食
